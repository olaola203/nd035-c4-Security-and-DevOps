...
public class CartController {
    ...
    public ResponseEntity<Cart> addTocart(@RequestBody ModifyCartRequest request) {
        ...
        log.info(String.format("[CartController] [addTocart] success for user %s, itemId %s", request.getUsername(), request.getItemId()));
    ...
    public ResponseEntity<Cart> removeFromcart(@RequestBody ModifyCartRequest request) {
        ...
        cartRepository.save(cart);
        log.info(String.format("[CartController] [removeFromcart] success for user %s, itemId %s", request.getUsername(), request.getItemId()));
        return ResponseEntity.ok(cart);
    }
